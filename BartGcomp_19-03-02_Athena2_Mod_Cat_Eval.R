...
# Cat19-03-09: bring the bytree back to the original version as in MPBART but faster
##############################################################
    ...
    if(tmp$doit){
      ...
      if(prevS == 0){
        ...
        while(redo == 1){
          ...
          if( all(c(a[3:4],b[3:4])>=0) & (diffTD < 1) ){
            redo = 0 
          } else {
...
save(seedvec, fml, res, baseyl, ntL, Bmod2, file = paste0("Cat19-03-09_",t,".RData"))
