...
######################################################################################################################
###BART-PBART-MPBART
newAcc_bpbmnp = function(mod, Smod, modfml, ted, times, types, intypes, maxt, basey1, basey){
  npost = mod[[1]]$ndraws
  lenmod = length(mod)
  nummod = length(types)
...
allres = newAcc_bpbmnp(mod, modfml, ted, times, types, intypes, maxt, basey1, basey)
