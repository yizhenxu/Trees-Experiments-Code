...
screennum = 
#always 100 trees for binary and continuous; different nt for multinomial
  
#70747 BART-PBART-MPBART modeling 20 trees 100 burn 4000 draws t=1,...,5
#70660 BART-PBART-MPBART modeling 20 trees 100 burn 4000 draws t=6,...,11  
  
#46844 BART-PBART-MPBART modeling 20 trees 100 burn 2000 draws t=1,...,5
#46887 BART-PBART-MPBART modeling 20 trees 100 burn 2000 draws t=6,...,11  
  
#59425 BART-PBART-MPBART modeling 30 trees 100 burn 3000 draws t=1,...,5
#59440 BART-PBART-MPBART modeling 30 trees 100 burn 3000 draws t=6,...,11
  
#46859 BART-PBART-MPBART modeling 50 trees 100 burn 2000 draws t=1,...,5
#46873 BART-PBART-MPBART modeling 50 trees 100 burn 2000 draws t=6,...,11  
  
#46538 BART-PBART-MPBART modeling 100 trees 100 burn 2000 draws t=1,...,5
#46495 BART-PBART-MPBART modeling 100 trees 100 burn 2000 draws t=6,...,11 

#46698 BART-PBART-MNP modeling t=1,...,5
#46763 BART-PBART-MNP modeling t=6,...,11
...
Mcmc_mult = function(p){
  return(list(sigma0 = diag(p-1), burn = nb, ndraws = nd, nSigDr = 1))
}
#-------------------------------
...
save(mod, modfml, file = paste0("B_PB_MPBART_screen",screennum,"_ct",ct-1,"_ntr",ntr,".RData"))
