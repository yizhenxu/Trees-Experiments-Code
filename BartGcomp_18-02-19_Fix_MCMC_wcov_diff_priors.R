...
#-------------------------------
load("BayesModwCD4_setting2.RData")
...
save(ndraw,nburn,nthin,npost,nchain,basey,mod,modfml,file = paste0("0219BayesModwCD4_setting",setting,".RData"))
...
proc.time() - ptm
#
save(Xmat,Smat,file = paste0("0219BayesSmat_setting",setting,".RData"))
