...
destfile = paste0("CK12-10-2019_sim",sim,"_ct",datseed,"_alg2.txt")
...
if(!file.exists(destfile)){
  ...
  res = c(am, as, acc)
  write(res,file =  paste0("CK12-10-2019_sim",sim,"_ct",datseed,"_alg2.txt"), sep="\n")
}

if(!file.exists(destfile)){
  resm = c(sim, datseed)
  write(resm,file =  "check2.txt",append=T, sep="\n")
}
