...
# A = 1 60786
# A = 0 60754
# A = I{CD4 updates &  CD4<=350} 60772 

# BART-PBART-MPBART(20 trees) 100 burn 2000 draws
# A = 1 60815
# A = 0 60464
# A = I{CD4 updates &  CD4<=350} 60800


#setwd("./Topic2");source(paste0("script_",screennum,".R"),echo=T)
#load("I:\\Topic2\\B_PB_MNP_screen54559_ct33_nsub50000.RData")

load("B_PB_MPBART_screen46844_ct33_ntr40000.RData")
...
proc.time() - ptm
#
save(Xmat,Smat,file = paste0("Gcomp_screen",screennum,"_ct",ct,"_ngc",ngc,".RData"))
...
tmp = lapply(1:maxt, function(i) engci(i, Smat, ngc))
...
plot(x, tab[1,],
     ylim=range(c(tab)),
     pch=19, xlab="Time", ylab="Differece in Percent Engaged",
