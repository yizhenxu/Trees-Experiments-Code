# Notes 
#update model_bart dependency mlogit
#update DiagPlot Inclusion Proportion as a list instead of matrix
#as.formula in model_bart
...
#setting1: 50 trees and all covariates, bytree using mympbartmod3
#setting2: 50 trees and all covariates, bylatent using mympbartmod3
#setting3: 50 trees and all covariates, bytree using mympbartmod2
#setting4: 100 for big cat (200 as num), 20 for small cats, bytree using mympbartmod3
#setting5: 100 for big cat (200 as num), 50 for small cats, bytree using mympbartmod3
#setting6: 200 for big cat (200 as num), 50 for small cats, bytree using mympbartmod3
#setting7: 20 trees and all covariates, bytree using mympbartmod3
#setting8: 100 trees and all covariates, bytree using mympbartmod3
#setting9: 200 trees and all covariates, bytree using mympbartmod3

#50 trees and use variablee selection for Eng model (see Athena0_screen), bytree using mympbartmod3
#setting1: using all vars
#setting10: reduce vars for xfer and death at prop 0.03
#setting11: reduce vars for xfer and death at prop 0.05
...
for(prevS in c(0,1)){ #### S_{t-1} = 0 - disengaged, 1 - engaged
  ...
  ntL[[ind]] = rep(50,p-1)#c(100,100,100),c(50,50,50),c(100,50,50)
  #ncov = rep(length(RHS), p-1)
  Yname = theY
...
save(fml,baseyl,ntL,Yname,Xname, Bmod2, file = "Mod3Run1.RData")
