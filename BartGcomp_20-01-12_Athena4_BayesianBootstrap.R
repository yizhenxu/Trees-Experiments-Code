...
for(i in 1:maxt){
  ...
  Smat[[i]] = matrix(NA, nrow = ngc, ncol = ndthin)
}
...
for(t in 1:maxt){
  ...
  save(Xmat,Smat,file = paste0("Gcomp_A",A,"_t",t,"_setting",setting,"_22-05-01.RData"))
  
}#for t



save(Xmat,Smat,file = paste0("Gcomp_A",A,"_setting",setting,"_22-05-01.RData"))
